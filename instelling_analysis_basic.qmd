...
all_applications <- read_csv("data/02_prepared/applications_enriched_with_context.csv", show_col_types = FALSE)
grouped_all_applications <- read_csv("data/02_prepared/applications_grouped.csv", show_col_types = FALSE)

cat("Voorbereide datasets geladen\n")
cat("Totaal aantal rijen (met context):", nrow(all_applications), "\n")
cat("Aantal gegroepeerde aanmeldingen:", nrow(grouped_all_applications), "\n")
...
cat("Schooljaren:", paste(unique(postcode_data$schooljaar), collapse = ", "), "\n")
