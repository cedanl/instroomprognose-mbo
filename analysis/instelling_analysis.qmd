---
title: "Instroomanalyse `r params$school_name` `r params$year` (`r params$brin_code`) `r params$suffix`"
...
# cache and freeze must be false since 00_setup modifies the environment
